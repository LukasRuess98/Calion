"""
Centralized logging configuration for CALION.
...
def setup_logging(
    ...
    """
    Configure root logger for CALION.
    ...
    # Set calion logger to configured level
    calion_logger = logging.getLogger('calion')
    calion_logger.setLevel(level)
...
def set_level(level: int) -> None:
    """
    Change logging level for all CALION loggers.
    ...
    Example:
        >>> import logging
        >>> from calion.logging_config import set_level
