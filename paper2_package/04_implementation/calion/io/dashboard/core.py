"""
Core dashboard class for the CALION Dashboard.

Contains the main CALIONDashboard class and create_dashboard function.
"""
...
def create_dashboard(
    workflow: Any,
    title: str = "CALION Interactive Dashboard",
    diagnose: bool = True
) -> Any:
    """
    Create an interactive Panel dashboard for CALION workflow results.
    ...
    **Troubleshooting:** If data is not displaying:
    ...
    dashboard = CALIONDashboard(workflow, title)

    return dashboard.create()


class CALIONDashboard:
    """
    Main dashboard class for CALION.
