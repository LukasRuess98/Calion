"""
Rolling Horizon Utility Modules.

This package contains utility functions extracted from rolling_horizon.py
to improve modularity and testability. Functions are grouped by their
domain:
...
- serialization: JSON-safe data conversion

All functions maintain their original _underscore prefix for backward
compatibility with existing calling code in rolling_horizon.py.
"""
