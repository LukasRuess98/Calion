...
genuinely inert in district-heating dispatch, or the assumptions under which we tested them
closed the channels through which they would have acted. The second reading is the
reviewer's, it is legitimate, and it deserves an answer more specific than a caveat.
...
The honest conclusion is therefore conditional, and we state it that way throughout: within
...
any of the four assumptions above -- which is why it, and not the nulls, is what the title
claims.
