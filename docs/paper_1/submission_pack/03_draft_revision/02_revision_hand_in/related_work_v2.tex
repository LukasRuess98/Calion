...
costs span 1--5\,\% of thermal energy cost~\cite{Frederiksen2013} -- a range this paper
returns to, since the network studied here falls two orders of magnitude below it for
...
below \SI{0.5}{\kelvin}, and transport delays of one to three hours arise in long
...
it is the value of the stochastic solution transposed from the uncertainty axis to the
resolution axis %% <<CITE-NEEDED:vss>> (add the standard VSS reference, e.g. Birge \&
%% Louveaux; no suitable key exists in Paper20_Literatur.bib)
-- and we claim the transposition and the empirical finding rather than the concept.
