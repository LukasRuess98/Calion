...
\textbf{95.8}\,\% and a spatial-topology main effect of \textbf{4.7}\,\%, and the same
holds across the synthetic factorial. The distinction is decision-relevant rather than
merely book-keeping: a copperplate understates cost by \textbf{15.1}\,\% yet, executed,
costs \textbf{46.1}\,\% more to operate, the two carrying opposite signs. The schedules show
why -- blind to the network losses, it provisions the heat pump for a demand that is too
small, running it some 246 fewer hours and at ten percentage points less share, and the
shortfall is then covered at the margin in winter hours it never planned for. A lumped
...
the measured burden with $R^2 = \textbf{0.87}$. A planner computes one number from pipe
lengths, insulation classes and an annual demand figure, and reads off whether a copperplate
will serve, whether a calibrated loss adder is adequate, or whether the nodes must be
resolved. Where a model must be resolved, effort belongs in the loss representation before
