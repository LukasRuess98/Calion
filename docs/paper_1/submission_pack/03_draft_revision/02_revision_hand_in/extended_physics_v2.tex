...
One property of this formulation determines how we report it. Freeing the node temperatures
...
bound, collapsing the loss term rather than reproducing the physical decay. In our solve it
...
measurement and we do not use it; the effect of temperature propagation is quantified
