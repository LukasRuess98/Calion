...
Section~\ref{subsec:validation}, including the several that are not met. The temperature gates in particular cannot be met by any model of
...
per-step energy closure. These are necessary conditions, not sufficient ones, and are labelled
as such; a post-upgrade measurement campaign is the natural follow-up and is listed
