...
linear levels are solved to a $0.01$\,\% gap; the one bilinear level (temperature propagation)
is solved to $0.1$\,\%, which still lies far below the effect it measures, and this asymmetry is
stated wherever that level is used.
...
reports the cost of executing a fixed schedule under the finer physics; it is a measurement
of that schedule, not a bound over all schedules the finer physics would admit. The instance
