%% ============================================================
%% NOMENCLATURE -- v2, Applied Energy house style.
...
\noindent
\begin{tabular*}{\columnwidth}{@{\extracolsep{\fill}} >{\raggedright}p{1.7cm} >{\raggedright}p{1.3cm} l @{}}
\toprule
...
\nom{c_p}{Specific heat capacity [J\,(kg\,K)$^{-1}$]}
\nom{\tau_p}{Transport delay [h]}
\nom{k_p}{Delay in time steps}
\nom{\phi_{p,t}}{Temperature decay factor}
...
\nom{\alpha_s}{Storage self-discharge rate [h$^{-1}$]}
...
\nom{\Delta T_{\mathrm{pp}}}{Heat-pump pinch-point temperature [K]}
...
\nom{C^{\mathrm{pump}}}{Network pumping cost}
