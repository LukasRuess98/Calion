...
The economic cost is reported because it is what an operator pays and is the primary
operator-cost basis for the reported comparisons; dispatch also changes emissions, storage
cycling and exports, which are accounted separately and not folded into the bias/regret
figures. Every bias and regret figure is computed \emph{directly} on this
...
(the copperplate bias reads $-12.2$\,\% rather than $-15.1$\,\%, and the loss share of the gap
reads $97.0$\,\% rather than $95.8$\,\%) and changes
neither the sign of any bias or regret figure nor the loss-dominance result---which the gross
basis in fact strengthens---because the credit is near-identical at every level. The per-level split is released as
...
near-uniform $3.5$\,\%: the loss share moves only from $95.8$ to $95.6$\,\%. The decomposition is thus stable to the objective--economic
