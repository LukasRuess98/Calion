...
% CHANGED: interaction term named. "to machine precision" is only defensible with all three
% terms present; 95.8 + 4.7 alone overshoots by 0.5 points.
copperplate-to-baseline cost gap decomposes to machine precision into a loss main effect of
\textbf{95.8}\,\%, a spatial-topology main effect of \textbf{4.7}\,\% and an interaction of
\textbf{$-0.5$}\,\%, and the same holds across the synthetic factorial. The distinction is
decision-relevant rather than merely book-keeping: a copperplate understates cost by
\textbf{15.1}\,\% yet, executed, costs \textbf{46.1}\,\% more to operate, the two carrying
opposite signs. The schedules show why: blind to the network losses, it provisions the heat pump
