...
How those gates are used is a deliberate choice. They are reported in full in Section~\ref{subsec:validation}, including the
several that are not met. The temperature gates in particular cannot be met by any model of
this network, for reasons of instrumentation set out there. Retaining gates the instrumentation cannot support, and
...
resolution verified. The conclusions are anchored instead to the annual delivered energy---which is gated and
met---and hence to the model-implied annual network loss it fixes, the quantity the cost
results depend on.
