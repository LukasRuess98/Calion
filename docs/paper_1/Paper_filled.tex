...
\begin{highlights}
  ...
  \item Physics inclusion gap (13\,\%) exceeds spatial refinement gap
        (2.4\,\%) and linearization error (0.35\,\%) by order of magnitude
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{../../output/paper_runs/figures/F1_experimental_design.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{../../output/paper_runs/figures/F2_network_topology.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{../../output/paper_runs/figures/FV1_validation_timeseries.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{../../output/paper_runs/figures/F3_cost_topology.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{../../output/paper_runs/figures/F5_cost_waterfall.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{../../output/paper_runs/figures/F7_TES_SOC_comparison.pdf}
...
$^{\ddagger}$L2 has more binaries than L3 because the L2 run was built
with \texttt{pressure\_drop: true}: the $K=3$ PWL segment selectors
add $6\,\text{pipes}\times 3\times 8760 = 157{,}680$ binaries on top of
the 52\,562 base. The L3 run used \texttt{pressure\_drop: false} (basic
physics only). This minor physics scope difference means that L2's
pumping cost is non-zero; however, the 6-zone aggregated pipes have
much larger effective diameters, making pumping costs ${<}\,0.05\,\%$
of total cost and negligible relative to the topology-driven L2--L3 gap
(2.4\,\%). The primary L2$\to$L3 comparison remains topology-dominated.
\end{table}
...
\begin{figure*}[!htbp]
  \centering
  \includegraphics[width=\textwidth]{../../output/paper_runs/figures/F10_node_topology_heatmap.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{../../output/paper_runs/figures/F11_critical_path_profile.pdf}
