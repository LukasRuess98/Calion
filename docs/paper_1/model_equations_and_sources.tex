...
\begin{equation}
  Q^{\text{pipe\,delivered}}_{t} + \sum_{i} Q^{\text{local,out}}_{i,t}
...
\begin{align}
  E_{t} &\leq \hat{E}    && \forall\, t \tag{ST-2} \label{eq:st2} \\
  E_{t} &\geq E_{\min}   && \forall\, t \tag{ST-3} \label{eq:st3}
\end{align}
...
% -----------------------------------------------
\subsection{Cyclic Boundary Condition}
...
The initial state-of-charge is a parameter $E_{0}$ that must not exceed capacity.
