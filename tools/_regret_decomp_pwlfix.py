...
Outputs: results/v2/analysis/regret_decomp_pwlfix.csv, regret_decomp_pricing_pwlfix.csv
"""
import dataclasses
import os
import sys
...
OUT = f"{WT}/output/paper1_v2_pwlfix"
...
def main():
    ...
    df.to_csv("results/v2/analysis/regret_decomp_pwlfix.csv", index=False)
    ...
    pdf.to_csv("results/v2/analysis/regret_decomp_pricing_pwlfix.csv", index=False)
    ...
    rdf.to_csv("results/v2/analysis/regret_recourse_pwlfix.csv", index=False)
    ...
    print("\nwrote regret_decomp_pwlfix.csv + regret_decomp_pricing_pwlfix.csv + regret_recourse_pwlfix.csv")
