...
headline claim (zero-param R2=0.86, MAE 4.8 pts, calibrated R2=0.93) with no stored
provenance. This tool recomputes them from the stored results/v2/analysis/fidelity_rule.csv
