...
```bash
# Level 1 — copperplate
python -m energis.run configs/examples/level1_copperplate.yaml

# Level 2 — 5-node network
python -m energis.run configs/examples/level2_5node.yaml

# With Rolling Horizon instead of Perfect Foresight
python -m energis.run configs/examples/level1_copperplate.yaml --run-mode RH_ONLY
```
