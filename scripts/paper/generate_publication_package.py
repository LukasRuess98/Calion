...
def main():
    ...
    checks = [
        ...
        ("Config L1", "Test-Path 'configs/paper/L1_copperplate_dispatch.yaml'"),
        ("Config L2", "Test-Path 'configs/paper/L2_simplified_dispatch.yaml'"),
        ("Config L3", "Test-Path 'configs/paper/L3_detailed_dispatch.yaml'"),
    ]
